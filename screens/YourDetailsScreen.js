...
<View className="flex-col mt-5 ml-5 mr-5 rounded-xl" style={{backgroundColor:"#F5F9FA"}}>
    <Text className="text-md text-gray-500 ml-3 mt-3 mb-2">Full Name</Text>
    <Text className="text-lg font-semibold ml-3 mb-3">Ashrrith Karunaakar</Text>
</View>
<View className="flex-col mt-5 ml-5 mr-5 rounded-xl" style={{backgroundColor:"#F5F9FA"}}>
    <Text className="text-md text-gray-500 ml-3 mt-3 mb-2">Email</Text>
    <Text className="text-lg font-semibold ml-3 mb-3">ashrrithk@gmail.com</Text>
</View>
</SafeAreaView>
  )
}