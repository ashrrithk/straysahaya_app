...
<Text className="font-medium text-xl mr-10 mb-2 ">Profile</Text>
</View>
</View>
...
<View className="flex-col justify-center w-6/6 h-12 rounded-xl m-5" style={{backgroundColor:'#F5F9FA'}}>
  ...
  {/* About Us */}
  <View className="flex-col justify-center w-6/6 h-12 rounded-xl ml-5 mr-5" style={{backgroundColor:'#F5F9FA'}}>
    <TouchableWithoutFeedback
    onPress={() => navigation.navigate('AboutUs')}
    >
  <View className="flex-row items-center justify-between">
        <Text className="text-lg font-semibold ml-5 ">About Us</Text>
        <Icons.ChevronRight height= '20' width= '20' stroke= "black" className="mr-3" />
  </View>
  </TouchableWithoutFeedback>
  </View>
...
{/* Contact */}
  <View className="flex-col justify-center w-6/6 h-12 rounded-xl m-5" style={{backgroundColor:'#F5F9FA'}}>
    <TouchableWithoutFeedback
    onPress={() => Linking.openURL('mailto: ashrrithk+straysahaya@gmail.com')}
    >
  <View className="flex-row items-center justify-between">
        <Text className="text-lg font-semibold ml-5 ">Contact</Text>
        <Icons.Mail height= '20' width= '20' stroke= "black" className="mr-3" />
  </View>
  </TouchableWithoutFeedback>
  </View>
