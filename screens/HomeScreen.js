...
export default function HomeScreen() {
  ...
  let id = process.env.SANITY_API_KEY;
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#ffffff", height: "100%" }}>
      ...
      <View className="flex-row items-center space-x-2 px-4 pb-2">
        ...
        >
          <Image
            source={require("../assets/freepik/siren.png")}
     ...
     <View className = "p-3 rounded-full">
        ...
        <View className="flex-row justify-evenly pt-5">
          <TouchableWithoutFeedback onPress={() => navigation.navigate("Help")}>
            <Image
              source={require("../assets/freepik/help.png")}
              style={{ width: 117, height: 138, borderRadius: 10 }}
            />
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback
          ...
          >
            <Image
              source={require("../assets/freepik/adopt.png")}
              style={{ width: 117, height: 138, borderRadius: 10 }}
            />
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback
          ...
          >
            <Image
              source={require("../assets/freepik/donate.png")}
              style={{ width: 117, height: 138, borderRadius: 10 }}
            />
          </TouchableWithoutFeedback>
        </View>
