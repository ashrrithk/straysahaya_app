...
import { setAdoption } from '../redux/slice/adoptSlice';
...
export default function AdoptDetailScreen() {
  ...
  <Text className="text-md font-medium ml-2 mt-2">{item.center}</Text>
  </View>
  </View>
  ...
  <View className="flex-col m-3 mt-5 " style={{backgroundColor:'#F5F9FA',borderRadius:20 }}>
    ...
    <Text className="m-3 text-md font-medium leading-5">{item.about.description}</Text>
