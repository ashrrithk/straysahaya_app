  ...
  return (
    <SafeAreaView style={{backgroundColor: 'white'}} className='h-full'>
     ...
     null}
        ...
        <View className="w-24 h-12  items-center justify-center rounded-md" style={{backgroundColor:'#f7f7f7'}}>
            <Ionicons name="call-outline" size={24} color="black" className="ml-5 mt-5"/>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {Linking.openURL(`https://${item?.google_map}`)}}>
        <View className="w-24 h-12 items-center justify-center rounded-md" style={{backgroundColor:'#f7f7f7'}}>
            <Ionicons name="map-outline" size={24} color="black" className="ml-5 mt-5"/>
        </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => {Linking.openURL(`mailto:${item?.email}`)}}>
              <View  className="w-24 h-12 items-center justify-center rounded-md" style={{backgroundColor:'#f7f7f7'}}>
            <Ionicons name="mail-outline" size={24} color="black" className="ml-5 mt-5"/>
            </View>
        </TouchableOpacity>
